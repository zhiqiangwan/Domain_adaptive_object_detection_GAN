'''
An encoder that converts ground truth annotations to SSD-compatible training targets (The offset between the groundtruth and the anchor boxes).
...
class SSDInputEncoder:
    ...
    training an SSD model. (The offset between the groundtruth and the anchor boxes).
    ...
    def __init__(self,
        ...
        self.steps_diag = [] # Horizontal and vertical distances between any two boxes centers for each predictor layer

...
def ssd_512(image_size,
    ...
    if mode == 'training':
        # base_model = Model(inputs=[x_source, x_target], outputs=[pool1_source, pool1_target])
        # model = Model(inputs=[x_source, x_target], outputs=predictions)
        ...
        base_model_output = Concatenate(axis=0)([base_model_source, base_model_target])

...
class DataGenerator:
    ...
    def generate(self,
        ...
        Arguments:
            ...
            generator_type: G or D or base. We need to generate different labels for these three networks.
        ...
        while True:
            ...
            batch_size_source = batch_X.shape[0]
            ret = []
            ...
            if 'encoded_labels' in returns:
                if generator_type == 'G':
                    ...
                    ret.append([np.zeros((batch_size_source, 1)), np.ones((batch_size_source, 1))])
                elif generator_type == 'base':
                    ret.append([batch_y_encoded])
                else:
                    raise Exception('generator_type should equal to G or D or base.')

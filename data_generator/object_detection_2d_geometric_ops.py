    ...
    def __call__(self, image, labels=None, return_inverter=False):
        ...
        if return_inverter:
            def inverter(labels):
                ...
                # In this inverter function, the index is ymin+1 not ymin.
                # This is because this invert function is applied on the predicted boxes.
                # The predicted boxes added one more axis (confidence) between classId and xmin.
...
class RandomFlip:
    ...
    def __init__(self,
        ...
        self.prob = prob
        self.labels_format = labels_format
        # There is no return_inverter for Flip. Maybe because Flip will not be used during evaluation.

...
class Evaluator:
    ...
    def predict_on_dataset(self,
        ...
        generator = self.data_generator.generate(batch_size=batch_size,
                                                 ...
                                                 returns={'processed_images',
                                                          ...
                                                          'inverse_transform',
                                                          'original_labels'},
                                                 keep_images_without_gt=False,  # True,
    ...
    def get_num_gt_per_class(self,
        ...
        # Iterate over the ground truth for all images in the dataset. len(ground_truth) : the number of images
        for i in tr:
    ...
    def match_predictions(self,
        ...
        # The false positives for each class, sorted by descending confidence. The first [] is for the groundtruth
        true_positives = [[]]
        ...
        for class_id in range(1, self.n_classes + 1):
            ...
            num_chars_per_image_id = len(str(predictions[0][0])) + 20 # Keep a few characters buffer in case some image IDs are longer than others.
            ...
            # Sort the detections by decreasing confidence. (np.argsort is ascending for default.)
